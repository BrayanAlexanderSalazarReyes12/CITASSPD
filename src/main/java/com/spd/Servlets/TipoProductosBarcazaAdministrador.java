 ...
 * @author braya
 */
public class TipoProductosBarcazaAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(operacion.equals("Barcaza - Barcaza")){
            RequestDispatcher dispatcher = request.getRequestDispatcher("/JSP/FormularioBarcazaABarcaza_Administrador.jsp");
            dispatcher.forward(request, response);
        }else{
           RequestDispatcher dispatcher = request.getRequestDispatcher("/JSP/FormularioBarcaza_Administrador.jsp?operacionselec=" + operacion);
           dispatcher.forward(request, response);
        }
    }
