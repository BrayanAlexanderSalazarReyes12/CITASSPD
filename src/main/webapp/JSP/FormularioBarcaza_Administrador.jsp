<%-- 
    Document   : FormularioBarcaza
    Created on : jun 5, 2025, 1:50:56 p.m.
    Author     : braya
--%>
        ...
        <form name="Formulario_Citas" action="./Formulario_SPD_Servlet" method="POST" enctype="multipart/form-data" class="formulario-citas" onsubmit="return desactivarBotonEnvio(this)">
            ...
            <div class="form-group">
                ...
                <input id="Cliente" type="text" name="Cliente"
                       value="<%= DATA != "" ? DATA : session.getAttribute("clienteForm") %>" readonly />
            </div>
            ...
            <div class="form-group">
                ...
                <input id="CantidadProducto" type="text" name="CantidadProducto"
                       value="<%= session.getAttribute("CantidadProducto") != null ? session.getAttribute("CantidadProducto") : "" %>"
            ...
            <div class="form-group">
                ...
                <input id="PesoProducto" type="text" name="PesoProducto"
                       value="<%= session.getAttribute("PesoProducto") != null ? session.getAttribute("PesoProducto") : "" %>"
                       oninput="this.value = this.value.replace(/[^0-9]/g, '')" required />
            </div>
            ...
            <div class="form-group">
                ...
                <input id="FacturaComercial" type="text" name="FacturaComercial"
                       value="<%= session.getAttribute("FacturaComercial") != null ? session.getAttribute("FacturaComercial") : "" %>"
                       maxlength="30" oninput="this.value = this.value.replace(/[^0-9a-zA-Z]/g, '')" required />
            </div>
